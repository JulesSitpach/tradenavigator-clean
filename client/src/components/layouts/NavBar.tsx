...
const NavBar = () => {
  ...
  const navItems = [
    { name: "Dashboard", href: "/" },
    { name: "Cost Analysis", href: "/cost-analysis" },
    { name: "Route Analysis", href: "/route-analysis" },
    { name: "Tariff Analysis", href: "/tariff-analysis" },
    { name: "Regulations", href: "/regulations-menu" },
  ];

  const moreItems = [
    { name: "Special Programs", href: "/special-programs" },
    { name: "Duty Drawback", href: "/duty-drawback" },
  ];
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <SimpleLink to="/" className="text-primary-600 dark:text-primary-400 text-xl font-bold">
                TradeNavigator
              </SimpleLink>
            </div>
                  ...
                  {moreItems.map((item) => (
                    <DropdownMenuItem key={item.href}>
                      <button 
                        ...
                        onClick={() => window.location.hash = item.href.replace(/^\//, '')}
                      >
                        {item.name}
                      </button>
                    </DropdownMenuItem>
